# AI 编程环境一键安装脚本
# 使用方式: irm https://raw.githubusercontent.com/dandanhua1/aiproj/main/install.ps1 | iex
$ErrorActionPreference = "Stop"
[Console]::OutputEncoding = [System.Text.Encoding]::UTF8

# 管理员权限检查（一行命令安装时需要自动提权）
$scriptUrl = "https://raw.githubusercontent.com/dandanhua1/aiproj/main/install.ps1"
